...
class _AddTaskPageState extends State<AddTaskPage> {
  ...
  _selectDate() async {
    ...
    if (pickeddate != null) {
      setState(() {
        myEditTask?.setDate(pickeddate.toString());
  ...
  _selectStartTime() async {
    ...
    if (pickedStartTime != null) {
      if (_endTime.compareTo(pickedStartTime) == 1) {
        setState(() {
          myEditTask?.setStartTime(pickedStartTime.format(context));
  ...
  _selectEndTime() async {
    ...
    if (pickedEndTime != null) {
      if (_startTime.compareTo(pickedEndTime) == -1) {
        setState(() {
          myEditTask?.setEndTime(pickedEndTime.format(context));
